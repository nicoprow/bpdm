...
class BusinessPartnerTaskResolutionV7IT: UnscheduledOrchestratorTestV7() {
    ...
    fun `resolve reserved task as legal entity`(){
        ...
        val expectedEntry = TaskStepReservationEntryDto(reservedTask.taskId, reservedTask.recordId, reservedTask.businessPartner)
        ...
        assertRepo.assertTaskReservationResponseEqual(actualReservationResponse, expectedResponse, ignoreRecordId = false)
    }
    ...
    fun `resolve task again`(){
        //GIVEN
        val createdTask = testDataClient.createTask(testName)
        val resultRequest1 = testDataClient.reserveAndResolveTask(createdTask.taskId, createdTask.processingState.step, "Resolved $testName")
        ...
        assertRepo.assertTaskReservationResponseEqual(actualReservationResponse, expectedResponse, ignoreRecordId = true)
    }
}